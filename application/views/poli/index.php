			...
			foreach ($poli as $key => $value):
				...
				<tr>
					...
					<td><?= $value['keterangan'] ?></td>
						<td><a href="<?= base_url('poli/update/') . $value['id_poli'] ?>"
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<textarea class="form-control" name="keterangan" placeholder="Input Keterangan" required rows="3" autocomplete="off"></textarea>
				</div>
			</div>
			<!-- footer modal -->
